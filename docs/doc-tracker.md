...
- 등록 도구: **17종** (`internal/mcp/toolslist.go` = `tests/integration/_helpers.py::EXPECTED_TOOLS`) — 그중 게이트 대상 쓰기 도구는 `resource_update`·`resource_patch`·`resource_delete` 3종이고, 게이트 밖 예외는 **1종**(`dear_baby_reset_user`)이다
