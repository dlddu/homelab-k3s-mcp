...
| 허브 도달 가능 문서 | ✅ **53 / 53** (가치 1 + PRD 15 + 테스트 15 + 상태 추적 5 + 정책 17), 끊긴 링크 0 |
...
### 시나리오 레지스트리 (85) — ✅ 전용 파일 73 · ⬜ 분할 대기 0 · ⏳ 구현 대기 11 · 🚫 예외 1

> 불변식이 여기서 눈으로 닫힌다: **85 − 1(예외) − 11(구현 대기) = 73 = 매칭 파일 73**, 공백 **0**.
